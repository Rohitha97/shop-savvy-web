        ...
        <div class="container-fluid py-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress w-100">
                                <div class="progress-bar bg-dark w-50" role="progressbar"
                                    aria-valuenow="{{ $usersCount }}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-xs mt-1 mb-0 font-weight-bold">Today Sales</p>
                            </div>
                            <h4 class="font-weight-bolder">{{ format_currency($todaySales) }}</h4>
                            <div class="progress w-100">
                ...
                <div class="col-3 py-3 ps-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="font-weight-bolder">{{ format_currency($totalSales) }}</h4>
                            <div class="progress w-100">
                ...
                <div class="col-3 py-3 ps-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="font-weight-bolder">{{ $productsCount }}</h4>
                            <div class="progress w-100">
                                <div class="progress-bar bg-dark w-50" role="progressbar"
                                    aria-valuenow="{{ $productsCount }}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-4">
                    <div class="card mb-4 h-100">
                        <div class="card-header pb-0">
                            <h6>Sales Summery (Compare to last month)</h6>
                        </div>
                        <div class="card-body pt-0 pb-2">
                            <canvas id="sales_summery_chart"></canvas>
                        </div>
                    </div>
                </div>
            </div>
